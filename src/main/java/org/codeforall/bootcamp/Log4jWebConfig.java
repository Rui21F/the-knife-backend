...
public class Log4jWebConfig implements ServletContextListener {
    ...
    public void contextInitialized(ServletContextEvent event) {
        ...
        String activeProfiles = event.getServletContext().getInitParameter("spring.profiles.active");

        String loggerPath = LOGGER_BASE_PATH + (activeProfiles.equals("prod") ? ".xml" : "-" + activeProfiles + ".xml");
